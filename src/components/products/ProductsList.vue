<template>
	<div class="grid">
		<div class="col-12">
			<div class="card">
        <Toast/>
				<h2 style="text-transform: capitalize;">{{categoryHeader}}</h2>
				<DataView :value="dataviewValue" :layout="layout" :paginator="true" :rows="9" :sortOrder="sortOrder" :sortField="sortField">
					...
					<template #list="slotProps">
						<div class="col-12">
                          ...
                          class="mb-2" @click="addToCart(slotProps.data)"></Button>
						...
						<div class="col-12 md:col-4">
							<div class="card m-3 border-1 surface-border">
								...
								<div class="flex align-items-center justify-content-between">
									...
									<Button icon="pi pi-shopping-cart" :disabled="slotProps.data.inventoryStatus === 'OUTOFSTOCK'" @click="addToCart(slotProps.data)"></Button>
								</div>
							</div>
						</div>
					</template>
