<template>
  <div class="">
    <div class="col-12">
      <div class="card">
        <Toast/>
        <DataTable ref="dt" :value="discounts" dataKey="id" :rows="10"
                   :rowsPerPageOptions="[5,10]"
                   responsiveLayout="scroll">
          <template #header>
            <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
              <h3 class="m-0">Discounts List</h3>
            </div>
          </template>

          <Column field="Title" header="Discount Title" :sortable="true" headerStyle="width:30%; min-width:10rem;">
            <template #body="slotProps">
              <span class="p-column-title">Discount Title</span>
              <span style="font-weight: bold;">{{ slotProps.data.title }}</span>
            </template>
          </Column>
          <Column field="Type" header="Requirements" :sortable="true" headerStyle="width:70%; min-width:10rem;">
            <template #body="slotProps">
